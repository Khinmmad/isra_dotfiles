        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    width: 32; height: 32
                    radius: 16
                    color: logoArea.containsMouse ? "#45475a" : "#313244" // Feedback visual
                ...
                // Separador visual solicitado entre Red y Procesador
                Item {
                    width: 20
                    height: 32
                    Layout.alignment: Qt.AlignVCenter
            ...
            // Launcher instanciado fuera del RowLayout para evitar recortes
            Launcher {
                id: appMenu
                anchorItem: logoContainer
            }
        }
    }
}